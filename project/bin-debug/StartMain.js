...
var StartMain = (function () {
    ...
    StartMain.LoadResVersionComplate = function () {
        Main.Instance.UpdateLoadingUI(false, "Reading Resources", 0.4, 1, 5000);
        if (true) {
    ...
    StartMain.prototype.onConfigComplete = function () {
        Main.Instance.UpdateLoadingUI(false, "Loading Configs", 0.6, 1, 5000);
    ...
    StartMain.prototype.onThemeLoadComplete = function () {
        ...
        var gameApp = new GameApp(function () {
            Main.Instance.UpdateLoadingUI(false, "Entering Game", 1, 1, 5);
            // 加载完成连接游戏服务器
