...
var MoneyTreePanel = (function (_super) {
    ...
    MoneyTreePanel.prototype.onTap = function (e) {
        switch (e.currentTarget) {
            case this.goUpBtn:
                ...
                UserTips.ins().showTips("|C:0xff0000&T:Not enough diamonds|");
                break;
            case this.image1:
    ...
    MoneyTreePanel.prototype.refushInfo = function (e, t) {
        ...
        if (model.playNum == model.maxNum) {
            ...
            this.getNum.text = "Obtain\n" + CommonUtils.overLength(Math.floor(costConfig.gold * infoConfig.rate / 100)) + " Gold";
        }
        this.add.text = "Extra: " + (infoConfig.rate - 100) + "%";
        this.bar.value = model.playNum;
        e || this.moveExpMc();
        var s = 0;
        null == infoConfigData
            ? (this.addPoint.text = "Max Level", this.mc_img.height = 76)
