...
var VipMainPanel = (function (_super) {
    ...
    VipMainPanel.prototype.gotoDes = function (vipLv) {
        ...
        this.vipLabel2.text = "VIP " + vipLv + " Perks";
        this.vipLabel3.text = "VIP " + vipLv + " Gift";
    ...
    VipMainPanel.prototype.changeExpBar = function () {
        ...
        if (nextConfig) {
            ...
            str = "|C:0xfff7e5&T:Recharge |C:0xffed21&T:" + nextNeedYb + " dollars ||C:0xfff7e5&T:to get ||C:0xffed21&T:VIP" + (vipData.lv + 1) + "|";
