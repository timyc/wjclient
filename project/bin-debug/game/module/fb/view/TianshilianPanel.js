...
var TianshilianPanel = (function (_super) {
    ...
    TianshilianPanel.prototype.upDateInfo = function () {
        ...
        if (this.tServer.layer > 0) {
            var strPassLv = "|C:0x6E330B&T:Highest Floor: |C:0x019704&T:" + this.tServer.layer + "|";
            //显示当前最大通关关数
    ...
    TianshilianPanel.prototype.onClickRw = function (e) {
        ...
        if (pData) {
            ...
            WarnWin.showReward("|C:0x6E330B&T: Pass |C:0x4fcd4c&T:" + strIndex + "|C:0x6E330B&T: and obtain|", this.getRewrd, this, null, null, "reward", { title: 'Rewards', reward: pData.firstAward, btnName: "Claim", bHideSureBtn: !bHaveGet });
        }
    };
    //领取宝箱奖励
    ...
    TianshilianPanel.NAME = "Essences";
