...
var GodLotteryResultPanel = (function (_super) {
    ...
    GodLotteryResultPanel.prototype.OnResume = function () {
        ...
        this.btn1.label = lotteryType == GodLotteryConst.TYPE_GOLD_ONE ? "x1" : "x10";
    ...
    GodLotteryResultPanel.prototype.UpdateTime = function () {
        this.timeLabel.textFlow = TextFlowMaker.generateTextFlow("Click anywhere to close |C:0x019704&T:(" + --this.mTime + "s)");
        if (this.mTime < 0) {
            this.CloseSelf();
        }
    };
